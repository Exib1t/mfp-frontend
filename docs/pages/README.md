...
No registration flow. Guest checkout only (phone + email).  
Account access — deferred. Planned: OTP via phone or email (no password).

## Status legend

🔲 planned → ✅ specced → 🚧 in progress → ✔️ done
